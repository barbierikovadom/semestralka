...
<div class="container">
    <div class="row">
        <div class="col-9">
            <img src="chmel-58506365_irecept-630-16x9.jpg" class="rounded mx-auto d-block img-fluid" alt="Responsive image">
            <p class="text-center">
                Nachádzame sa v Hornej Lehote. V malebnej dedine na stredom Slovenku, v blízkosti Nízkych Tatier.
            </p>
        </div>
        <div class="col-3">
            <p class="text-center">
